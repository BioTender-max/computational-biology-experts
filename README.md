...
<table>
  <tr>
    <td align="center" width="200">
      <a href="./david-baker/">
        <img src="./david-baker/avatar.png" width="120" style="border-radius:50%" alt="David Baker"/><br/>
        <b>David Baker</b><br/>
        <sub>🔬 Protein Design</sub><br/>
        <sub><i>Nobel 2024 · Rosetta · RFDiffusion</i></sub>
      </a>
    </td>
    <td align="center" width="200">
      <a href="./demis-hassabis/">
        <img src="./demis-hassabis/avatar.png" width="120" style="border-radius:50%" alt="Demis Hassabis"/><br/>
        <b>Demis Hassabis</b><br/>
        <sub>🔬 AI for Biology</sub><br/>
        <sub><i>Nobel 2024 · AlphaFold · DeepMind</i></sub>
      </a>
    </td>
    <td align="center" width="200">
      <a href="./eugene-myers/">
        <img src="./eugene-myers/avatar.png" width="120" style="border-radius:50%" alt="Eugene Myers"/><br/>
        <b>Eugene Myers</b><br/>
        <sub>🔬 Genome Assembly</sub><br/>
        <sub><i>Breakthrough Prize · BLAST · WGS</i></sub>
      </a>
    </td>
    <td align="center" width="200">
      <a href="./aviv-regev/">
        <img src="./aviv-regev/avatar.png" width="120" style="border-radius:50%" alt="Aviv Regev"/><br/>
        <b>Aviv Regev</b><br/>
        <sub>🔬 Single-Cell Genomics</sub><br/>
        <sub><i>Human Cell Atlas · scRNA-seq</i></sub>
      </a>
    </td>
  </tr>
  <tr>
    <td align="center" width="200">
      <a href="./lior-pachter/">
        <img src="./lior-pachter/avatar.png" width="120" style="border-radius:50%" alt="Lior Pachter"/><br/>
        <b>Lior Pachter</b><br/>
        <sub>🔬 Computational Genomics</sub><br/>
        <sub><i>kallisto · pseudoalignment · sleuth</i></sub>
      </a>
    </td>
    <td align="center" width="200">
      <a href="./bonnie-berger/">
        <img src="./bonnie-berger/avatar.png" width="120" style="border-radius:50%" alt="Bonnie Berger"/><br/>
        <b>Bonnie Berger</b><br/>
        <sub>🔬 Mathematical Biology</sub><br/>
        <sub><i>Compressive genomics · IsoRank</i></sub>
      </a>
    </td>
    <td align="center" width="200">
      <a href="./ewan-birney/">
        <img src="./ewan-birney/avatar.png" width="120" style="border-radius:50%" alt="Ewan Birney"/><br/>
        <b>Ewan Birney</b><br/>
        <sub>🔬 Genome Annotation</sub><br/>
        <sub><i>Ensembl · ENCODE · GeneWise</i></sub>
      </a>
    </td>
    <td align="center" width="200">
      <a href="./soren-brunak/">
        <img src="./soren-brunak/avatar.png" width="120" style="border-radius:50%" alt="Søren Brunak"/><br/>
        <b>Søren Brunak</b><br/>
        <sub>🔬 Disease Systems Biology</sub><br/>
        <sub><i>SignalP · disease trajectories · EHR</i></sub>
      </a>
    </td>
  </tr>
  <tr>
    <td align="center" width="200">
      <a href="./christina-leslie/">
        <img src="./christina-leslie/avatar.png" width="120" style="border-radius:50%" alt="Christina Leslie"/><br/>
        <b>Christina Leslie</b><br/>
        <sub>🔬 ML for Genomics</sub><br/>
        <sub><i>String kernels · GraphReg</i></sub>
      </a>
    </td>
    <td align="center" width="200">
      <a href="./bernhard-scholkopf/">
        <img src="./bernhard-scholkopf/avatar.png" width="120" style="border-radius:50%" alt="Bernhard Schölkopf"/><br/>
        <b>Bernhard Schölkopf</b><br/>
        <sub>🔬 Causal ML</sub><br/>
        <sub><i>SVMs · kernel methods · causality</i></sub>
      </a>
    </td>
    <td align="center" width="200">
      <a href="./dana-peer/">
        <img src="./dana-peer/avatar.png" width="120" style="border-radius:50%" alt="Dana Pe'er"/><br/>
        <b>Dana Pe'er</b><br/>
        <sub>🔬 Single-Cell / Cancer</sub><br/>
        <sub><i>Palantir · MAGIC · Wanderlust</i></sub>
      </a>
    </td>
    <td align="center" width="200">
      <a href="./manolis-kellis/">
        <img src="./manolis-kellis/avatar.png" width="120" style="border-radius:50%" alt="Manolis Kellis"/><br/>
        <b>Manolis Kellis</b><br/>
        <sub>🔬 Comparative Genomics</sub><br/>
        <sub><i>ChromHMM · ENCODE · Alzheimer's</i></sub>
      </a>
    </td>
  </tr>
  <tr>
    <td align="center" width="200">
      <a href="./eran-segal/">
        <img src="./eran-segal/avatar.png" width="120" style="border-radius:50%" alt="Eran Segal"/><br/>
        <b>Eran Segal</b><br/>
        <sub>🔬 Personalized Medicine</sub><br/>
        <sub><i>Personalized nutrition · microbiome</i></sub>
      </a>
    </td>
    <td align="center" width="200">
      <a href="./daphne-koller/">
        <img src="./daphne-koller/avatar.png" width="120" style="border-radius:50%" alt="Daphne Koller"/><br/>
        <b>Daphne Koller</b><br/>
        <sub>🔬 Probabilistic AI / Drug Discovery</sub><br/>
        <sub><i>PGMs · Coursera · insitro · MacArthur Fellow</i></sub>
      </a>
    </td>
    <td align="center" width="200">
      <a href="./richard-durbin/">
        <img src="./richard-durbin/avatar.png" width="120" style="border-radius:50%" alt="Richard Durbin"/><br/>
        <b>Richard Durbin</b><br/>
        <sub>🔬 Population Genomics</sub><br/>
        <sub><i>BWA · GATK · 1000 Genomes</i></sub>
      </a>
    </td>
    <td align="center" width="200">
      <a href="./heng-li/">
        <img src="./heng-li/avatar.png" width="120" style="border-radius:50%" alt="Heng Li"/><br/>
        <b>Heng Li</b><br/>
        <sub>🔬 Sequence Alignment</sub><br/>
        <sub><i>BWA · SAMtools · minimap2</i></sub>
      </a>
    </td>
  </tr>
  <tr>
    <td align="center" width="200">
      <a href="./sean-eddy/">
        <img src="./sean-eddy/avatar.png" width="120" style="border-radius:50%" alt="Sean Eddy"/><br/>
        <b>Sean Eddy</b><br/>
        <sub>🔬 Sequence Analysis</sub><br/>
        <sub><i>HMMER · Rfam · Infernal</i></sub>
      </a>
    </td>
    <td align="center" width="200">
      <a href="./pavel-pevzner/">
        <img src="./pavel-pevzner/avatar.png" width="120" style="border-radius:50%" alt="Pavel Pevzner"/><br/>
        <b>Pavel Pevzner</b><br/>
        <sub>🔬 Genome Assembly</sub><br/>
        <sub><i>SPAdes · de Bruijn graphs</i></sub>
      </a>
    </td>
    <td align="center" width="200">
      <a href="./steven-salzberg/">
        <img src="./steven-salzberg/avatar.png" width="120" style="border-radius:50%" alt="Steven Salzberg"/><br/>
        <b>Steven Salzberg</b><br/>
        <sub>🔬 Genome Annotation</sub><br/>
        <sub><i>HISAT2 · StringTie · CHESS</i></sub>
      </a>
    </td>
    <td align="center" width="200">
      <a href="./michael-schatz/">
        <img src="./michael-schatz/avatar.png" width="120" style="border-radius:50%" alt="Michael Schatz"/><br/>
        <b>Michael Schatz</b><br/>
        <sub>🔬 Genome Assembly</sub><br/>
        <sub><i>MUMmer · long-read assembly</i></sub>
      </a>
    </td>
  </tr>
  <tr>
    <td align="center" width="200">
      <a href="./jared-simpson/">
        <img src="./jared-simpson/avatar.png" width="120" style="border-radius:50%" alt="Jared Simpson"/><br/>
        <b>Jared Simpson</b><br/>
        <sub>🔬 Nanopore Genomics</sub><br/>
        <sub><i>nanopolish · ABySS · f5c</i></sub>
      </a>
    </td>
    <td align="center" width="200">
      <a href="./john-novembre/">
        <img src="./john-novembre/avatar.png" width="120" style="border-radius:50%" alt="John Novembre"/><br/>
        <b>John Novembre</b><br/>
        <sub>🔬 Population Genetics</sub><br/>
        <sub><i>STRUCTURE · ADMIXTURE · POPRES</i></sub>
      </a>
    </td>
    <td align="center" width="200">
      <a href="./jonathan-pritchard/">
        <img src="./jonathan-pritchard/avatar.png" width="120" style="border-radius:50%" alt="Jonathan Pritchard"/><br/>
        <b>Jonathan Pritchard</b><br/>
        <sub>🔬 Human Genetics</sub><br/>
        <sub><i>STRUCTURE · polygenic adaptation</i></sub>
      </a>
    </td>
    <td align="center" width="200">
      <a href="./alkes-price/">
        <img src="./alkes-price/avatar.png" width="120" style="border-radius:50%" alt="Alkes Price"/><br/>
        <b>Alkes Price</b><br/>
        <sub>🔬 Statistical Genetics</sub><br/>
        <sub><i>EIGENSTRAT · LD Score regression</i></sub>
      </a>
    </td>
  </tr>
  <tr>
    <td align="center" width="200">
      <a href="./nir-friedman/">
        <img src="./nir-friedman/avatar.png" width="120" style="border-radius:50%" alt="Nir Friedman"/><br/>
        <b>Nir Friedman</b><br/>
        <sub>🔬 Probabilistic Genomics</sub><br/>
        <sub><i>Bayesian networks · scRNA-seq</i></sub>
      </a>
    </td>
    <td align="center" width="200">
      <a href="./albert-laszlo-barabasi/">
        <img src="./albert-laszlo-barabasi/avatar.png" width="120" style="border-radius:50%" alt="Albert-László Barabási"/><br/>
        <b>Albert-László Barabási</b><br/>
        <sub>🔬 Network Science</sub><br/>
        <sub><i>Scale-free networks · interactome</i></sub>
      </a>
    </td>
    <td align="center" width="200">
      <a href="./trey-ideker/">
        <img src="./trey-ideker/avatar.png" width="120" style="border-radius:50%" alt="Trey Ideker"/><br/>
        <b>Trey Ideker</b><br/>
        <sub>🔬 Systems Biology</sub><br/>
        <sub><i>Cytoscape · DCell · network medicine</i></sub>
      </a>
    </td>
    <td align="center" width="200">
      <a href="./fabian-theis/">
        <img src="./fabian-theis/avatar.png" width="120" style="border-radius:50%" alt="Fabian Theis"/><br/>
        <b>Fabian Theis</b><br/>
        <sub>🔬 Computational Biology</sub><br/>
        <sub><i>scVI · scANVI · CellRank · SCANPY</i></sub>
      </a>
    </td>
  </tr>
  <tr>
    <td align="center" width="200">
      <a href="./rahul-satija/">
        <img src="./rahul-satija/avatar.png" width="120" style="border-radius:50%" alt="Rahul Satija"/><br/>
        <b>Rahul Satija</b><br/>
        <sub>🔬 Single-Cell Genomics</sub><br/>
        <sub><i>Seurat · WNN · SCTransform · Azimuth</i></sub>
      </a>
    </td>
    <td align="center" width="200">
      <a href="./sarah-teichmann/">
        <img src="./sarah-teichmann/avatar.png" width="120" style="border-radius:50%" alt="Sarah Teichmann"/><br/>
        <b>Sarah Teichmann</b><br/>
        <sub>🔬 Single-Cell Genomics</sub><br/>
        <sub><i>Human Cell Atlas · cell2location</i></sub>
      </a>
    </td>
    <td align="center" width="200">
      <a href="./cole-trapnell/">
        <img src="./cole-trapnell/avatar.png" width="120" style="border-radius:50%" alt="Cole Trapnell"/><br/>
        <b>Cole Trapnell</b><br/>
        <sub>🔬 Single-Cell Genomics</sub><br/>
        <sub><i>Monocle · sci-RNA-seq · TopHat</i></sub>
      </a>
    </td>
    <td align="center" width="200">
      <a href="./peter-kharchenko/">
        <img src="./peter-kharchenko/avatar.png" width="120" style="border-radius:50%" alt="Peter Kharchenko"/><br/>
        <b>Peter Kharchenko</b><br/>
        <sub>🔬 Single-Cell Methods</sub><br/>
        <sub><i>SCDE · velocyto · Numbat · Baysor</i></sub>
      </a>
    </td>
  </tr>
  <tr>
    <td align="center" width="200">
      <a href="./bing-ren/">
        <img src="./bing-ren/avatar.png" width="120" style="border-radius:50%" alt="Bing Ren"/><br/>
        <b>Bing Ren</b><br/>
        <sub>🔬 Epigenomics</sub><br/>
        <sub><i>ChIP-seq · ATAC-seq · Hi-C · ABC model</i></sub>
      </a>
    </td>
    <td align="center" width="200">
      <a href="./rob-knight/">
        <img src="./rob-knight/avatar.png" width="120" style="border-radius:50%" alt="Rob Knight"/><br/>
        <b>Rob Knight</b><br/>
        <sub>🔬 Microbiome</sub><br/>
        <sub><i>QIIME2 · UniFrac · Earth Microbiome</i></sub>
      </a>
    </td>
    <td align="center" width="200">
      <a href="./curtis-huttenhower/">
        <img src="./curtis-huttenhower/avatar.png" width="120" style="border-radius:50%" alt="Curtis Huttenhower"/><br/>
        <b>Curtis Huttenhower</b><br/>
        <sub>🔬 Microbiome</sub><br/>
        <sub><i>MetaPhlAn · HUMAnN · bioBakery</i></sub>
      </a>
    </td>
    <td align="center" width="200">
      <a href="./peer-bork/">
        <img src="./peer-bork/avatar.png" width="120" style="border-radius:50%" alt="Peer Bork †"/><br/>
        <b>Peer Bork †</b><br/>
        <sub>🔬 Metagenomics</sub><br/>
        <sub><i>STRING · iTOL · SMART · enterotypes</i></sub>
      </a>
    </td>
  </tr>
  <tr>
    <td align="center" width="200">
      <a href="./martin-steinegger/">
        <img src="./martin-steinegger/avatar.png" width="120" style="border-radius:50%" alt="Martin Steinegger"/><br/>
        <b>Martin Steinegger</b><br/>
        <sub>🔬 Sequence Analysis</sub><br/>
        <sub><i>MMseqs2 · ColabFold · Foldseek</i></sub>
      </a>
    </td>
    <td align="center" width="200">
      <a href="./andrej-sali/">
        <img src="./andrej-sali/avatar.png" width="120" style="border-radius:50%" alt="Andrej Sali"/><br/>
        <b>Andrej Sali</b><br/>
        <sub>🔬 Structural Biology</sub><br/>
        <sub><i>MODELLER · IMP · Nuclear Pore Complex</i></sub>
      </a>
    </td>
    <td align="center" width="200">
      <a href="./brian-shoichet/">
        <img src="./brian-shoichet/avatar.png" width="120" style="border-radius:50%" alt="Brian Shoichet"/><br/>
        <b>Brian Shoichet</b><br/>
        <sub>🔬 Drug Discovery</sub><br/>
        <sub><i>Ultra-large docking · colloidal aggregation</i></sub>
      </a>
    </td>
    <td align="center" width="200">
      <a href="./ron-dror/">
        <img src="./ron-dror/avatar.png" width="120" style="border-radius:50%" alt="Ron Dror"/><br/>
        <b>Ron Dror</b><br/>
        <sub>🔬 Molecular Simulation</sub><br/>
        <sub><i>Anton · GPCR mechanisms · MD + ML</i></sub>
      </a>
    </td>
  </tr>
  <tr>
    <td align="center" width="200">
      <a href="./stein-aerts/">
        <img src="./stein-aerts/avatar.png" width="120" style="border-radius:50%" alt="Stein Aerts"/><br/>
        <b>Stein Aerts</b><br/>
        <sub>🔬 Regulatory Genomics</sub><br/>
        <sub><i>SCENIC · cisTopic · CREsted</i></sub>
      </a>
    </td>
    <td align="center" width="200">
      <a href="./barbara-engelhardt/">
        <img src="./barbara-engelhardt/avatar.png" width="120" style="border-radius:50%" alt="Barbara Engelhardt"/><br/>
        <b>Barbara Engelhardt</b><br/>
        <sub>🔬 Probabilistic ML</sub><br/>
        <sub><i>PEER · GTEx · GPLVM · ISCB Overton 2021</i></sub>
      </a>
    </td>
    <td align="center" width="200">
      <a href="./anshul-kundaje/">
        <img src="./anshul-kundaje/avatar.png" width="120" style="border-radius:50%" alt="Anshul Kundaje"/><br/>
        <b>Anshul Kundaje</b><br/>
        <sub>🔬 Regulatory Genomics</sub><br/>
        <sub><i>BPNet · ChromBPNet · TF-MoDISco · ENCODE</i></sub>
      </a>
    </td>
    <td align="center" width="200">
      <a href="./ben-raphael/">
        <img src="./ben-raphael/avatar.png" width="120" style="border-radius:50%" alt="Ben Raphael"/><br/>
        <b>Ben Raphael</b><br/>
        <sub>🔬 Cancer Genomics</sub><br/>
        <sub><i>HATCHet · THetA · TCGA · ISCB Innovator 2021</i></sub>
      </a>
    </td>
  </tr>
  <tr>
    <td align="center" width="200">
      <a href="./gad-getz/">
        <img src="./gad-getz/avatar.png" width="120" style="border-radius:50%" alt="Gad Getz"/><br/>
        <b>Gad Getz</b><br/>
        <sub>🔬 Cancer Genomics</sub><br/>
        <sub><i>MutSig · MuTect · GISTIC · TCGA GDAC</i></sub>
      </a>
    </td>
    <td align="center" width="200">
      <a href="./li-ding/">
        <img src="./li-ding/avatar.png" width="120" style="border-radius:50%" alt="Li Ding"/><br/>
        <b>Li Ding</b><br/>
        <sub>🔬 Cancer Proteogenomics</sub><br/>
        <sub><i>First cancer genome · TCGA · CPTAC</i></sub>
      </a>
    </td>
    <td align="center" width="200">
      <a href="./gunnar-ratsch/">
        <img src="./gunnar-ratsch/avatar.png" width="120" style="border-radius:50%" alt="Gunnar Rätsch"/><br/>
        <b>Gunnar Rätsch</b><br/>
        <sub>🔬 ML for Medicine</sub><br/>
        <sub><i>Tumor Profiler · deep learning pathology</i></sub>
      </a>
    </td>
    <td align="center" width="200">
      <a href="./jure-leskovec/">
        <img src="./jure-leskovec/avatar.png" width="120" style="border-radius:50%" alt="Jure Leskovec"/><br/>
        <b>Jure Leskovec</b><br/>
        <sub>🔬 Graph Neural Networks</sub><br/>
        <sub><i>PyG · GraphSAGE · Decagon · TDC</i></sub>
      </a>
    </td>
  </tr>
  <tr>
    <td align="center" width="200">
      <a href="./olga-troyanskaya/">
        <img src="./olga-troyanskaya/avatar.png" width="120" style="border-radius:50%" alt="Olga Troyanskaya"/><br/>
        <b>Olga Troyanskaya</b><br/>
        <sub>🔬 Genomic Integration</sub><br/>
        <sub><i>DeepSEA · Sei · Bayesian integration</i></sub>
      </a>
    </td>
    <td align="center" width="200">
      <a href="./wouter-meuleman/">
        <img src="./wouter-meuleman/avatar.png" width="120" style="border-radius:50%" alt="Wouter Meuleman"/><br/>
        <b>Wouter Meuleman</b><br/>
        <sub>🔬 Regulatory Genomics</sub><br/>
        <sub><i>DHS Index · DNA-Diffusion · augmented genomics</i></sub>
      </a>
    </td>
    <td align="center" width="200">
      <a href="./yun-song/">
        <img src="./yun-song/avatar.png" width="120" style="border-radius:50%" alt="Yun Song"/><br/>
        <b>Yun Song</b><br/>
        <sub>🔬 Probabilistic Genomics</sub><br/>
        <sub><i>Coalescent theory · probabilistic models</i></sub>
      </a>
    </td>
    <td align="center" width="200">
      <a href="./elhanan-borenstein/">
        <img src="./elhanan-borenstein/avatar.png" width="120" style="border-radius:50%" alt="Elhanan Borenstein"/><br/>
        <b>Elhanan Borenstein</b><br/>
        <sub>🔬 Microbiome Systems</sub><br/>
        <sub><i>Metabolic modeling · multi-omics microbiome</i></sub>
      </a>
    </td>
  </tr>
  <tr>
...
Each scientist's folder is a self-contained reasoning package:
...
Load the relevant scientist's skill when working on a problem in their domain:
...
| Network / systems biology | [Albert-László Barabási](./albert-laszlo-barabasi/) · [Trey Ideker](./trey-ideker/) · [Jure Leskovec](./jure-leskovec/) |
...
1. **Source discovery** — WebSearch across intent buckets: essays, talks, interviews, frameworks, papers, lab philosophy, award lectures
